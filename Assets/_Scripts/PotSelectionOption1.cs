...
public class PotSelectionOption1 : MonoBehaviour
{
    ...
    [Header("Alternates")]
    public GameObject alternateForTreeA; // The tree to show if Bonsai_Tree_1_New_Pot is active
    public GameObject alternateForTreeB; // The tree to show if Bonsai_Tree_9_Orig is active
    ...
    public void SwitchBasedOnCurrent()
    {
        ...
        //if (currentTree.name == "Bonsai_Tree_1_New_Pot")
        //{
        //    nextTree = alternateForTreeA;
        //}
        //else if (currentTree.name == "Bonsai_Tree_9_Orig")
        //{
        //    nextTree = alternateForTreeB;
        //}
